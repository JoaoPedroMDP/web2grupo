            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-wrapper">
                        <h1 class="page-title"><c:choose><c:when test="${requestScope.action == 'new'}">Adicionar Categoria</c:when><c:when test="${requestScope.action == 'update'}">Editar Categoria</c:when></c:choose> </h1>
                            </div>
                            <div style="display:flex; justify-content: center; align-items: center;">
                                <div class="text-center mt-5" >   
                                    <div style="display:flex; justify-content: center; flex-direction: column; align-items: center">
                                            <form class="row g-3" name="form" action="CategoryServlet?id=${idUpdate}&action=${requestScope.action}" method="POST">
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="col-md">
