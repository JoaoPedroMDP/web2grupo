        ...
        <div class="container-fluid">
          ...
          <table class="container-fluid d-flex justify-content-center justify-content-around">
              <tbody>
                ...
                <tr class="report-box roundy d-flex flex-column align-items-center m-4">
                    <td><button id="select-action" class="btn list-group-item-light-personalized align-content-end" href="#!">Adicionar Categoria</button></td>  
                </tr>
              </tbody>
          </table>
        </div>
