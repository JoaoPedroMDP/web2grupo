    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Conteúdo da Página -->
          <table class="container-fluid d-flex justify-content-center justify-content-around">
              <tbody>
                <tr>
                    <th>Produtos</th>
                    <th>Categorias<th>
                ...
                <tr>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Produto</td>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Shampoo</td>
                    <td><a class="dropdown-item" href="#!">Editar</a></td>
                    <td><a class="dropdown-item"href="#!">Remover</a></td>
                </tr>
                <tr>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Produto</td>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Condicionador</td>
                    <td><a class="dropdown-item" href="#!">Editar</a></td>
                    <td><a class="dropdown-item"href="#!">Remover</a></td>
                </tr>
                <tr>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Produto</td>
                    <td class="container-fluid d-print-table list-group-item-light-personalized ">Sabonete</td>
                    <td><a class="dropdown-item" href="#!">Editar</a></td>
                    <td><a class="dropdown-item"href="#!">Remover</a></td>
                </tr>
                <tr>
                    <td class="report-box roundy d-flex  m-4" ><button id="select-action" class="btn list-group-item-light-personalized " href="#!">Voltar</button> </td> <td></td>
                    <td><button id="select-action" class="btn list-group-item-light-personalized  align-content-end" href="#!">Adicionar Produto</button></td>  
                </tr>
              </tbody>
          </table>
        </div>
