                ...
                <div class="card-body">
                  <div class="mb-3 col-md-7">
                    <p class="fst-italic fs-3">
                      <strong>Título:</strong> Caíram todos os meus cabelos
                    </p>
                  </div>
                  <div class="mb-3 col-md-7">
                    <p class="fst-italic fs-3">
                      <strong>Produto:</strong> Shampoo Embuste
                    </p>
                  </div>
                  <div class="mb-3 col-md-7">
                    <p class="fst-italic fs-3">
                      <strong>Cliente:</strong> Beltrano dos Santos
                    </p>
                  </div>
                  <div class="mb-3 col-md-7">
                    <p class="fst-italic fs-3">
                      <strong>Tipo:</strong> Reclamação
                    </p>
                  </div>
                  <div class="p-3 mb-2 bg-secondary rounded bg-opacity-25">
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Donec tincidunt tempor tellus eu tristique. Lorem ipsum
                      dolor sit amet, consectetur adipiscing elit. Etiam a
                      placerat massa, vitae finibus neque. Fusce interdum
                      placerat urna, sit amet fringilla quam. Sed porttitor at
                      leo et convallis. Fusce sodales quam in dui vehicula
                      consectetur. Duis tempus nulla vel eros luctus, id
                      accumsan nunc suscipit. Donec aliquet magna cursus finibus
                      feugiat. Ut viverra volutpat ipsum, interdum tempor nisi
                      ultricies a. Orci varius natoque penatibus et magnis dis
