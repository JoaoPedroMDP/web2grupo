                ...
                <div class="card-body">
                  <form action="" method="post">
                    ...
                    <div class="mb-3 col-md-12">
                      ...
                      <textarea class="form-control" placeholder="Campo não permitido" id="resposta" rows="3" disabled="true"></textarea>
                    </div>
                    <div class="mb-3 col-md-3">
                      <br>
                      <label class="form-label" for="resposta">Nota do atendimento:</label>
                      <select class="form-select" aria-label="Default select example">
                        <option selected>Selecione a nota do atendimento</option>
                    ...
                    <div class="d-grid gap-2 d-md-flex">
                      <a href="callList.jsp" class="btn btn-danger d-flex align-items-center justify-content-center p-1 col-md-2" id="justify-content-start">
                      <span class="material-icons m-sm-1">close</span>Cancelar</a>
                      <a href="callList.jsp" class="btn btn-primary d-flex align-items-center justify-content-center p-1 col-md-2" id="justify-content-end">
                      <span class="material-icons m-sm-1">post_add</span>Cadastrar Atendimento</a>
                    </div>
                  </form>
                </div>
              </div>
